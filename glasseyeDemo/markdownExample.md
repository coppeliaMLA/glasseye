...
Then you should be able to run the following in a terminal<sidenote>You'll need to add the cloned repository to your PYTHON PATH. Please see the repository README for details.</sidenote>
